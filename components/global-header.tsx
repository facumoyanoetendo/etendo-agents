...
export function GlobalHeader({ user, userRole, initialConversations, agentPath, activeConversationId, agentId, disableHamburgerMenu }: GlobalHeaderProps) {
